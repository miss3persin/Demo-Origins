      ...
      <div className='relative flex-grow pb-20 pt-16 lg:pt-28'>
        <div className='mb-10 mt-8 flex justify-center gap-10'>
          {prevChapterId && (
            <button
              ...
              className='flex items-center sm:text-sm md:text-sm lg:text-lg 2xl:text-2xl text-xs justify-center gap-3 rounded border border-blue-500 bg-blue-500 px-4 py-2 text-white transition-all duration-200 ease-in-out hover:bg-transparent hover:text-black dark:border-[#ACA992] dark:bg-transparent dark:text-[#ACA992] dark:hover:bg-[#ACA992] dark:hover:text-black'
            >
        ...
        <div className='my-8 flex justify-center gap-10'>
          {prevChapterId && (
            <button
              onClick={() => router.push(`/chapters/${prevChapterId}`)}
              className='sm:text-sm md:text-sm lg:text-lg 2xl:text-2xl text-xs flex items-center justify-center gap-3 rounded border border-blue-500 bg-blue-500 px-4 py-2 text-white transition-all duration-200 ease-in-out hover:bg-transparent hover:text-black dark:border-[#ACA992] dark:bg-transparent dark:text-[#ACA992] dark:hover:bg-[#ACA992] dark:hover:text-black'
            >
              <ChevronLeftIcon className='hidden md:flex md:h-4 md:w-5 lg:h-5 lg:w-6 2xl:h-7 2xl:w-6' />
              Previous Chapter
            </button>
