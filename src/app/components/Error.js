    ...
    <div className="flex items-center justify-center min-w-screen min-h-screen bg-gray-50 dark:bg-black">
      <div className='flex flex-col gap-10 items-center justify-center'>
        <p className='text-4xl text-gray-900 dark:text-[#ACA992]'>
          Failed to get data. {randomEmoticon}
        </p>
        <p className='text-gray-900 dark:text-[#ACA992]'>
          It's either the network connection is bad or the chapter isn't available yet.
        </p>
      </div>
    </div>
  );
